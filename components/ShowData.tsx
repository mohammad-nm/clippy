...
export default async function ShowData({
  ...
  return (
    <div className="max-w-6xl m-auto font-mono  mt-20 p-4 sm:p-8 transition-all ease-in-out duration-300 transform hover:scale-105">
      <Card
        variant="outlined"
        className="w-full p-4 sm:p-6 shadow-xl hover:shadow-2xl transition-shadow duration-300"
      >
